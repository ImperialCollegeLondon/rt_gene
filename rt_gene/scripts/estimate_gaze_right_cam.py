...
class GazeEstimatorROS(object):
    ...
    def __init__(self, device_id_gaze, model_files):
        ...
        self.image_subscriber = rospy.Subscriber("/right_subjects/images", MSG_SubjectImagesList, self.image_callback, queue_size=3, buff_size=2**24)
        self.subjects_gaze_img = rospy.Publisher("/right_subjects/gazeimages", Image, queue_size=3)
        self.gaze_publishers = rospy.Publisher("/right_subjects/gaze", MSG_GazeList, queue_size=3)
...
if __name__ == "__main__":
    try:
        rospy.init_node("right_sestimate_gaze")
